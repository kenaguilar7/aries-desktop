namespace AriesContador.Data.Migrations
{
    ...
    public static class ExpectedSchema
    {
        ...
        public static readonly string[] ProceduresCalledByCode =
        {
            ...
            "SP_CopyChartOfAccounts",
            "SP_InsertChartFromTemp",
        ...
        public static readonly ExpectedColumn[] Columns =
        {
            ...
            new ExpectedColumn("products", "product_id"),
            new ExpectedColumn("products", "company_id") { CharLength = 5, Nullable = false },
            new ExpectedColumn("products", "barcode"),
            ...
            new ExpectedColumn("sales_registers", "name"),
            new ExpectedColumn("sales_register_sessions", "session_id"),
            new ExpectedColumn("sales_register_sessions", "sales_register_id"),
            new ExpectedColumn("sales_register_sessions", "company_id") { CharLength = 5, Nullable = false },
            new ExpectedColumn("sales_register_sessions", "opened_at"),
            new ExpectedColumn("sales_register_sessions", "closed_at"),
            new ExpectedColumn("sales_register_sessions", "open_flag"),
            new ExpectedColumn("sales", "sale_id"),
            new ExpectedColumn("sales", "company_id") { CharLength = 5, Nullable = false },
            new ExpectedColumn("sales", "sales_register_id"),
            ...
            new ExpectedColumn("purchase_account_maps", "purchase_account_map_id"),
            new ExpectedColumn("purchase_account_maps", "company_id") { CharLength = 5, Nullable = false },
            new ExpectedColumn("purchase_account_maps", "inventory_account_id"),
            new ExpectedColumn("purchase_account_maps", "tax_account_id"),
            new ExpectedColumn("purchase_account_maps", "payable_account_id"),
            new ExpectedColumn("purchase_account_maps", "tax_rate"),
            new ExpectedColumn("purchase_postings", "purchase_posting_id"),
        ...
        public static readonly ExpectedParameter[] ProcedureParameters =
        {
            ...
            new ExpectedParameter("SP_CopyChartOfAccounts", "FromCompany", "varchar(5)", "IN"),
